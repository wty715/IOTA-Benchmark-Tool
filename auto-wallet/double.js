const config = {'host'                : require('./config-double.json').host,
                'port'                : require('./config-double.json').port,
                'seed'                : require('./config-double.json').seed,
                'amount'              : require('./config-double.json').amount,
                'language'            : require('./config-double.json').language,
                'address'             : require('./config-double.json').address,
                'address2'            : require('./config-double.json').address2,
                'tag'                 : require('./config-double.json').tag,
                'depth'               : require('./config-double.json').depth,
                'minWeightMagnitude'  : require('./config-double.json').minWeightMagnitude
               }
